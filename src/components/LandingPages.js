...
const LandingPages = () => {
  return (
    <div >
        ...
        <div className='download ' id='Download'>
          <div className='container'>
            <div className='lg:flex download justify-center lg:ml-[100px]  ml-[40px] gap-2'>
              <div className='lg:w-1/2 lg:mt-[100px] mt-10 '>
                <div className='download-info'>
                  <h2 className='text-4xl fill-mode-both duration-1000 delay-0 repeat-1  pb-4 lg:pt-0 p-16'>Smart City
        ...
        <section id="Contact" className='bg-[#fafbfd] pb-8'>
