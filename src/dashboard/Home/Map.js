...
const Map = () => {
  ...
  <div>
    ...
    <Marker position={[-1.939927, 30.047957]} icon={customIcon} className="custom-marker">
    <Popup>
      A custom marker with a red background.
    </Popup>
  </Marker>
  <Marker position={[-1.972749, 30.094112]} icon={customIcon} className="custom-marker">
  <Popup>
    Zinia.
  </Popup>
</Marker>
<Marker position={[-1.964116, 30.022416]} icon={customIcon} className="custom-marker">
<Popup>
  karama
</Popup>
</Marker>
